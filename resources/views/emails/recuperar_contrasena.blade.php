...
<body>
    <div class="container">
        ...
        <div class="banner">Recupera tu contraseña</div>
        <div class="content">
            <div class="title">¡Hola {{ $nombre }}! 👋</div>
            <div class="subtitle">
                Te enviamos este correo para ayudarte a recuperar el acceso a tu cuenta
            </div>

            <div class="action-box">
                <p style="margin: 0 0 12px 0; color: #444;">
                    <strong>Haz clic aquí para recuperar tu contraseña:</strong>
                </p>
                <a href="{{ $recuperarContrasenaUrl }}" class="reset-button">Recuperar mi contraseña</a>
            </div>
            ...
            <div class="footer">
                Si tienes algún problema, no dudes en contactarnos.<br><br>
                ¡Saludos!<br>
                Equipo Probusiness
            </div>
