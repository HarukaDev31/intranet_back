...
class ReminderInicialWhatsAppFinished implements ShouldBroadcast, ShouldQueue
{
    ...
    {
        return 'ReminderInicialWhatsAppFinished';
    }
    ...
    public function broadcastWith()
    {
        return [
            ...
            'tipo_evento' => 'reminder_inicial_whatsapp_finished',
        ];
    }
}
