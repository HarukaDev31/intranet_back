...
class CreateBdProductosRegulacionesAntidumpingMediaTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('bd_productos_regulaciones_antidumping_media', function (Blueprint $table) {
            $table->id();
            $table->unsignedBigInteger('id_regulacion')->comment('ID de la regulación antidumping');
            ...
            // Foreign key
            $table->foreign('id_regulacion', 'fk_antidumping_media_regulacion')
                  ->references('id')
                  ->on('bd_productos_regulaciones_antidumping')
                  ->onDelete('cascade')
                  ->onUpdate('cascade');
        });
    }
    ...
    {
        Schema::dropIfExists('bd_productos_regulaciones_antidumping_media');
    }
}
