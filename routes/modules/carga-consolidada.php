...
Route::group(['prefix' => 'carga-consolidada', 'middleware' => ['jwt.auth', 'carga-consolidada.organizacion', 'carga-consolidada.cache']], function () {
    ...
    Route::group(['prefix' => 'contenedor'], function () {
        ...
        Route::put('tc-yuan-global', [ContenedorController::class, 'updateTcYuanGlobal']);
        Route::post('tc-yuan-global', [ContenedorController::class, 'updateTcYuanGlobal']);
        ...
        Route::group(['prefix' => 'cotizacion-final'], function () {
            ...
            Route::put('/general/{idContenedor}/fecha-maxima-pago', [CotizacionFinalController::class, 'updateFechaMaximaPago']);
            ...
            Route::get('/general/{idCotizacion}/preview-reminder-pago', [CotizacionFinalController::class, 'previewReminderPago']);
            Route::post('/general/{idCotizacion}/send-reminder-pago', [CotizacionFinalController::class, 'sendReminderPago']);
        ...
        Route::group(['prefix' => 'entrega'], function () {
            ...
            Route::post('/delivery/servicio-line', [EntregaController::class, 'storeDeliveryServicioLine']);
            Route::put('/delivery/servicio-line/{idLinea}', [EntregaController::class, 'updateDeliveryServicioLine']);
